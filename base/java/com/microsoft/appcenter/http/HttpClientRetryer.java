...
public class HttpClientRetryer extends HttpClientDecorator {
    ...
    public class RetryableCall extends HttpClientCallDecorator {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:6:0x0013, code lost:
            r0 = ((com.microsoft.appcenter.http.HttpException) r6).getHttpResponse().getHeaders().get(com.microsoft.appcenter.http.DefaultHttpClient.X_MS_RETRY_AFTER_MS_HEADER);
         */

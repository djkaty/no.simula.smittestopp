...
public class AnalyticsValidator extends AbstractChannelListener {
    ...
    public static com.microsoft.appcenter.ingestion.models.properties.TypedProperty copyProperty(com.microsoft.appcenter.ingestion.models.properties.TypedProperty r3, java.lang.String r4) {
        /*
    ...
    public static Map<String, String> validateProperties(Map<String, String> map, String str, String str2) {
        if (map == null) {
            return null;
        }
    ...
    public static void validateProperties(List<TypedProperty> list) {
        boolean z;
        if (list != null) {

...
public class ErrorLogHelper {
    ...
    public static ManagedErrorLog createErrorLog(Context context, Thread thread, Throwable th, Map<Thread, StackTraceElement[]> map, long j2) {
        return createErrorLog(context, thread, getModelExceptionFromThrowable(th), map, j2, true);
    }
    ...
    public static Exception getModelExceptionFromThrowable(Throwable th) {
        ...
        if (linkedList.size() > 16) {
            StringBuilder a = a.a("Crash causes truncated from ");
    ...
    public static List<StackFrame> getModelFramesFromStackTrace(Throwable th) {
        ...
        if (stackTrace.length > 256) {
            ...
            StringBuilder a = a.a("Crash frames truncated from ");
            a.append(stackTrace.length);
            a.append(" to ");
            a.append(256);
            a.append(" frames.");
            AppCenterLog.warn(Crashes.LOG_TAG, a.toString());
    ...
    public static StackFrame getModelStackFrame(StackTraceElement stackTraceElement) {
    ...
    public static synchronized File getNewMinidumpSubfolderWithContextData(Context context) {
        ...
        synchronized (ErrorLogHelper.class) {
            ...
            try {
                ...
                AppCenterLog.error(Crashes.LOG_TAG, "Failed to store device info in a minidump folder.", e2);
                file.delete();
            }
        }
    ...
    public static File getStoredErrorLogFile(UUID uuid) {
    ...
    public static Device parseDevice(String str) {
        try {
            ...
            AppCenterLog.error(Crashes.LOG_TAG, "Failed to deserialize device info.", e2);
            return null;
        }
    }
    ...
    public static void removeStoredErrorLogFile(UUID uuid) {
        ...
        if (storedErrorLogFile != null) {
            StringBuilder a = a.a("Deleting error log file ");
            a.append(storedErrorLogFile.getName());
            AppCenterLog.info(Crashes.LOG_TAG, a.toString());
    ...
    public static void removeStoredThrowableFile(UUID uuid) {
        ...
        if (storedThrowableFile != null) {
            StringBuilder a = a.a("Deleting throwable file ");
            a.append(storedThrowableFile.getName());
            AppCenterLog.info(Crashes.LOG_TAG, a.toString());
    ...
    public static ManagedErrorLog createErrorLog(Context context, Thread thread, Exception exception, Map<Thread, StackTraceElement[]> map, long j2, boolean z) {
        ...
        try {
            ...
            AppCenterLog.error(Crashes.LOG_TAG, "Could not attach device properties snapshot to error log, will attach at sending time", e2);
        }
    ...
    public static List<StackFrame> getModelFramesFromStackTrace(StackTraceElement[] stackTraceElementArr) {

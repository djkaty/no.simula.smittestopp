...
public class AppCenter {
    ...
    private synchronized boolean configureInstance(android.app.Application r4, java.lang.String r5, final boolean r6) {
        /*
            ...
            com.microsoft.appcenter.utils.AppCenterLog.error(r4, r5)     // Catch:{ all -> 0x008b }
            monitor-exit(r3)
            return r0
        L_0x000d:
            boolean r1 = r3.mLogLevelConfigured     // Catch:{ all -> 0x008b }
            if (r1 != 0) goto L_0x001f
            android.content.pm.ApplicationInfo r1 = r4.getApplicationInfo()     // Catch:{ all -> 0x008b }
            int r1 = r1.flags     // Catch:{ all -> 0x008b }
            r2 = 2
            r1 = r1 & r2
            if (r1 != r2) goto L_0x001f
            r1 = 5
            com.microsoft.appcenter.utils.AppCenterLog.setLogLevel(r1)     // Catch:{ all -> 0x008b }
        L_0x001f:
            java.lang.String r1 = r3.mAppSecret     // Catch:{ all -> 0x008b }
            if (r6 == 0) goto L_0x002b
            boolean r5 = r3.configureSecretString(r5)     // Catch:{ all -> 0x008b }
            if (r5 != 0) goto L_0x002b
            monitor-exit(r3)
            return r0
        L_0x002b:
            android.os.Handler r5 = r3.mHandler     // Catch:{ all -> 0x008b }
            r0 = 1
            if (r5 == 0) goto L_0x0048
            java.lang.String r4 = r3.mAppSecret     // Catch:{ all -> 0x008b }
            if (r4 == 0) goto L_0x0046
            java.lang.String r4 = r3.mAppSecret     // Catch:{ all -> 0x008b }
            boolean r4 = r4.equals(r1)     // Catch:{ all -> 0x008b }
            if (r4 != 0) goto L_0x0046
            android.os.Handler r4 = r3.mHandler     // Catch:{ all -> 0x008b }
            com.microsoft.appcenter.AppCenter$4 r5 = new com.microsoft.appcenter.AppCenter$4     // Catch:{ all -> 0x008b }
            r5.<init>()     // Catch:{ all -> 0x008b }
            r4.post(r5)     // Catch:{ all -> 0x008b }
        L_0x0046:
            monitor-exit(r3)
            return r0
        L_0x0048:
            r3.mApplication = r4     // Catch:{ all -> 0x008b }
            android.os.HandlerThread r4 = new android.os.HandlerThread     // Catch:{ all -> 0x008b }
            java.lang.String r5 = "AppCenter.Looper"
            r4.<init>(r5)     // Catch:{ all -> 0x008b }
            r3.mHandlerThread = r4     // Catch:{ all -> 0x008b }
            r4.start()     // Catch:{ all -> 0x008b }
            android.os.Handler r4 = new android.os.Handler     // Catch:{ all -> 0x008b }
            android.os.HandlerThread r5 = r3.mHandlerThread     // Catch:{ all -> 0x008b }
            android.os.Looper r5 = r5.getLooper()     // Catch:{ all -> 0x008b }
            r4.<init>(r5)     // Catch:{ all -> 0x008b }
            r3.mHandler = r4     // Catch:{ all -> 0x008b }
            com.microsoft.appcenter.AppCenter$5 r4 = new com.microsoft.appcenter.AppCenter$5     // Catch:{ all -> 0x008b }
            r4.<init>()     // Catch:{ all -> 0x008b }
            r3.mAppCenterHandler = r4     // Catch:{ all -> 0x008b }
            java.util.HashSet r4 = new java.util.HashSet     // Catch:{ all -> 0x008b }
            r4.<init>()     // Catch:{ all -> 0x008b }
            r3.mServices = r4     // Catch:{ all -> 0x008b }
            java.util.HashSet r4 = new java.util.HashSet     // Catch:{ all -> 0x008b }
            r4.<init>()     // Catch:{ all -> 0x008b }
            r3.mServicesStartedFromLibrary = r4     // Catch:{ all -> 0x008b }
            android.os.Handler r4 = r3.mHandler     // Catch:{ all -> 0x008b }
            com.microsoft.appcenter.AppCenter$6 r5 = new com.microsoft.appcenter.AppCenter$6     // Catch:{ all -> 0x008b }
            r5.<init>(r6)     // Catch:{ all -> 0x008b }
            r4.post(r5)     // Catch:{ all -> 0x008b }
            java.lang.String r4 = "AppCenter"
            java.lang.String r5 = "App Center SDK configured successfully."
            com.microsoft.appcenter.utils.AppCenterLog.info(r4, r5)     // Catch:{ all -> 0x008b }
            monitor-exit(r3)
            return r0
        L_0x008b:
            r4 = move-exception
    ...
    public void finishConfiguration(boolean z) {
        ...
        this.mChannel.addGroup(CORE_GROUP, 50, DefaultChannel.MINIMUM_TRANSMISSION_INTERVAL, 3, (Ingestion) null, (Channel.GroupListener) null);
        ...
        if (this.mLogUrl != null) {
            if (this.mAppSecret != null) {
                StringBuilder a = a.a("The log url of App Center endpoint has been changed to ");
                a.append(this.mLogUrl);
                AppCenterLog.info("AppCenter", a.toString());
                this.mChannel.setLogUrl(this.mLogUrl);
            } else {
                StringBuilder a2 = a.a("The log url of One Collector endpoint has been changed to ");
                a2.append(this.mLogUrl);
    ...
    public void setInstanceEnabled(boolean z) {
        ...
        if (z2) {
            ...
            StringBuilder a = a.a("App Center has already been ");
            if (!z) {
                str = "disabled";
            }
            a.append(str);
    ...
    private synchronized AppCenterFuture<Boolean> setInstanceMaxStorageSizeAsync(long j2) {
        ...
        if (this.mConfiguredFromApp) {
            ...
            defaultAppCenterFuture.complete(false);
            return defaultAppCenterFuture;
        } else if (j2 < MINIMUM_STORAGE_SIZE) {
            ...
            this.mMaxStorageSizeInBytes = j2;
    ...
    public static AppCenterFuture<Boolean> setMaxStorageSize(long j2) {
        return getInstance().setInstanceMaxStorageSizeAsync(j2);
    }
    ...
    private void startOrUpdateServiceFromApp(AppCenterService appCenterService, Collection<AppCenterService> collection, Collection<AppCenterService> collection2) {
        ...
        if (this.mServices.contains(appCenterService)) {
            ...
            StringBuilder a = a.a("App Center has already started the service with class name: ");
            a.append(appCenterService.getServiceName());
            AppCenterLog.warn("AppCenter", a.toString());
        ...
        for (Class<? extends AppCenterService> cls : clsArr) {
            if (cls == null) {
                ...
                try {
                    ...
                    AppCenterLog.error("AppCenter", "Failed to get service instance '" + cls.getName() + "', skipping it.", e2);
                }
            }
        }
        this.mHandler.post(new Runnable() {

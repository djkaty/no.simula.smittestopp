...
public class GetCurrentAccountCommand extends BaseCommand<List<ICacheRecord>> {
    ...
    public GetCurrentAccountCommand(OperationParameters operationParameters, BaseController baseController, CommandCallback commandCallback) {
    ...
    public GetCurrentAccountCommand(OperationParameters operationParameters, List<BaseController> list, CommandCallback commandCallback) {

...
public class WebSocketHandlerImpl implements WebSocketHandler {
    ...
    public String createUpgradeRequest(String str, String str2, String str3, int i2, String str4, Map<String, String> map) {
        WebSocketUpgrade createWebSocketUpgrade = createWebSocketUpgrade(str, str2, str3, i2, str4, map);
        this.webSocketUpgrade = createWebSocketUpgrade;
        return createWebSocketUpgrade.createUpgradeRequest();
    }

    public WebSocketUpgrade createWebSocketUpgrade(String str, String str2, String str3, int i2, String str4, Map<String, String> map) {
        return new WebSocketUpgrade(str, str2, str3, i2, str4, map);
    }
    ...
    public Boolean validateUpgradeReply(ByteBuffer byteBuffer) {
        Boolean bool = false;
        if (this.webSocketUpgrade != null && byteBuffer.remaining() > 0) {
            byte[] bArr = new byte[byteBuffer.remaining()];
            byteBuffer.get(bArr);
            bool = this.webSocketUpgrade.validateUpgradeReply(bArr);

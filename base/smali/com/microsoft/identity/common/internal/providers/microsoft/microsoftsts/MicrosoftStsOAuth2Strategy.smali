...
# static fields
.field public static final TAG:Ljava/lang/String; = "MicrosoftStsOAuth2Strategy"
...
.method private getCloudSpecificTokenEndpoint(Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftAuthorizationRequest;Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftAuthorizationResponse;)Ljava/lang/String;
    .locals 3

    .line 1
    invoke-virtual {p2}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftAuthorizationResponse;->getCloudInstanceHostName()Ljava/lang/String;
    ...
    .line 6
    invoke-virtual {v0, v1, p1}, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsOAuth2Configuration;->getOpenIdWellKnownConfig(Ljava/lang/String;Ljava/lang/String;)Lcom/microsoft/identity/common/internal/providers/oauth2/OpenIdProviderConfiguration;
    ...
    .line 7
    invoke-virtual {p1}, Lcom/microsoft/identity/common/internal/providers/oauth2/OpenIdProviderConfiguration;->getTokenEndpoint()Ljava/lang/String;
    ...
    sget-object v0, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsOAuth2Strategy;->TAG:Ljava/lang/String;

    const-string v1, ":getCloudSpecificTokenEndpoint"

    const-string v2, "Token Endpoint not obtained from well known config. Building token endpoint manually."

    invoke-static {p1, v0, v1, v2}, Le/a/a/a/a;->b(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 10
    check-cast p2, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationResponse;

    invoke-direct {p0, p2}, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsOAuth2Strategy;->buildCloudSpecificTokenEndpoint(Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationResponse;)Ljava/lang/String;
...
.method private performPKeyAuthRequest(Lcom/microsoft/identity/common/internal/net/HttpResponse;Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsTokenRequest;)Lcom/microsoft/identity/common/internal/net/HttpResponse;
    ...
    const-string v2, "#performPkeyAuthRequest"
    ...
    const-string v3, "Device certificate challenge request. "
    ...
    .line 8
    :try_start_0
    new-instance v1, Lcom/microsoft/identity/common/internal/ui/webview/challengehandlers/PKeyAuthChallengeFactory;

    invoke-direct {v1}, Lcom/microsoft/identity/common/internal/ui/webview/challengehandlers/PKeyAuthChallengeFactory;-><init>()V
    ...
    .line 11
    invoke-virtual {v1, p1, v3}, Lcom/microsoft/identity/common/internal/ui/webview/challengehandlers/PKeyAuthChallengeFactory;->getPKeyAuthChallenge(Ljava/lang/String;Ljava/lang/String;)Lcom/microsoft/identity/common/internal/ui/webview/challengehandlers/PKeyAuthChallenge;
    ...
    .line 15
    invoke-static {v2, v0, p1, p2}, Lcom/microsoft/identity/common/internal/net/HttpRequest;->sendPost(Ljava/net/URL;Ljava/util/Map;[BLjava/lang/String;)Lcom/microsoft/identity/common/internal/net/HttpResponse;
...
.method public createAccount(Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsTokenResponse;)Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAccount;
    ...
    const-string v3, "Creating account from TokenResponse..."
    ...
    invoke-direct {p1, v0, v1}, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAccount;-><init>(Lcom/microsoft/identity/common/internal/providers/oauth2/IDToken;Lcom/microsoft/identity/common/internal/providers/microsoft/azureactivedirectory/ClientInfo;)V
    ...
    invoke-static {v0, v3, v1}, Lcom/microsoft/identity/common/internal/logging/Logger;->error(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public createAuthorizationRequestBuilder()Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationRequest$Builder;
    ...
    const-string v1, ":createAuthorizationRequestBuilder"
    ...
    const-string v2, "Creating AuthorizationRequestBuilder..."
    ...
    .line 5
    iget-object v2, p0, Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Strategy;->mConfig:Lcom/microsoft/identity/common/internal/providers/oauth2/OAuth2Configuration;

    check-cast v2, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsOAuth2Configuration;

    invoke-virtual {v2}, Lcom/microsoft/identity/common/internal/providers/microsoft/azureactivedirectory/AzureActiveDirectoryOAuth2Configuration;->getAuthorityUrl()Ljava/net/URL;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftAuthorizationRequest$Builder;->setAuthority(Ljava/net/URL;)Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftAuthorizationRequest$Builder;
    ...
    invoke-virtual {v2}, Lcom/microsoft/identity/common/internal/providers/microsoft/azureactivedirectory/AzureActiveDirectoryOAuth2Configuration;->getSlice()Lcom/microsoft/identity/common/internal/providers/microsoft/azureactivedirectory/AzureActiveDirectorySlice;
    ...
    invoke-virtual {v0, v2}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftAuthorizationRequest$Builder;->setLibraryName(Ljava/lang/String;)Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftAuthorizationRequest$Builder;
...
.method public createAuthorizationRequestBuilder(Lcom/microsoft/identity/common/internal/dto/IAccountRecord;)Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationRequest$Builder;
    ...
    invoke-virtual {v0, v2}, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationRequest$Builder;->setUid(Ljava/lang/String;)Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationRequest$Builder;
    ...
    invoke-virtual {v0, v2}, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationRequest$Builder;->setUtid(Ljava/lang/String;)Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationRequest$Builder;
    ...
    invoke-static {v2, v3, v1}, Le/a/a/a/a;->a(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string v3, "Builder w/ uid: ["
    ...
    invoke-static {v2, v3}, Lcom/microsoft/identity/common/internal/logging/Logger;->infoPII(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, p1}, Lcom/microsoft/identity/common/internal/logging/Logger;->infoPII(Ljava/lang/String;Ljava/lang/String;)V
...
.method public createTokenRequest(Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationRequest;Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationResponse;Lcom/microsoft/identity/common/internal/authscheme/AbstractAuthenticationScheme;)Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsTokenRequest;
    ...
    .line 5
    invoke-direct {p0, p1, p2}, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsOAuth2Strategy;->getCloudSpecificTokenEndpoint(Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftAuthorizationRequest;Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftAuthorizationResponse;)Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/microsoft/identity/common/internal/providers/oauth2/PkceChallenge;->getCodeVerifier()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftTokenRequest;->setCodeVerifier(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;->setCode(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;->setRedirectUri(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;->setClientId(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;->setScope(Ljava/lang/String;)V
    ...
    .line 21
    sget-object p3, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsOAuth2Strategy;->TAG:Ljava/lang/String;
    ...
    invoke-static {p3, p2}, Lcom/microsoft/identity/common/internal/logging/Logger;->verbosePII(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p3, "Cannot execute PoP request sans Context"
...
.method public getTokenResultFromHttpResponse(Lcom/microsoft/identity/common/internal/net/HttpResponse;)Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResult;
    ...
    const-string v1, "Getting TokenResult from HttpResponse..."
    ...
    invoke-direct {v2, v1, v0}, Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResult;-><init>(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenResponse;Lcom/microsoft/identity/common/internal/providers/oauth2/TokenErrorResponse;)V

    .line 13
    sget-object v0, Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsOAuth2Strategy;->TAG:Ljava/lang/String;

    invoke-static {v0, v2}, Lcom/microsoft/identity/common/internal/controllers/BaseController;->logResult(Ljava/lang/String;Lcom/microsoft/identity/common/internal/providers/oauth2/IResult;)V
    ...
    invoke-virtual {v1, v0}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftTokenResponse;->setSpeRing(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftTokenResponse;->setRefreshTokenAge(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftTokenResponse;->setCliTelemErrorCode(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1}, Lcom/microsoft/identity/common/internal/providers/microsoft/MicrosoftTokenResponse;->setCliTelemSubErrorCode(Ljava/lang/String;)V

    :cond_2
    return-object v2
.end method

.method public performTokenRequest(Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsTokenRequest;)Lcom/microsoft/identity/common/internal/net/HttpResponse;
    .locals 3
...
.method public bridge synthetic performTokenRequest(Lcom/microsoft/identity/common/internal/providers/oauth2/TokenRequest;)Lcom/microsoft/identity/common/internal/net/HttpResponse;
    .locals 0
...
.method public validateAuthorizationRequest(Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsAuthorizationRequest;)V
    .locals 0
...
.method public validateTokenRequest(Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsTokenRequest;)V
    .locals 0
...
.method public validateTokenResponse(Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsTokenRequest;Lcom/microsoft/identity/common/internal/providers/microsoft/microsoftsts/MicrosoftStsTokenResponse;)V
    .locals 0
